...
function getData(lang, cb) {
	const clientId = 'gw9u5pj12v4bdxsw8ej49fibzr7za4';
	const limit = 15;
	isLoading = true;
	...
	$.ajax({
		...
		// var apiUrl = 'https://api.twitch.tv/kraken/streams/?client-id=' + clientId + '&game=League%20of%20Legends&limit=' + limit + '&offset=' + nowIndex;
...
function changeLang(lang) {
	nowIndex = 0;
	// getData(lang, function(err, data) {
...
function getColumn(data) {
	...
	<div class="col">
		...
		<div class="bottom">
			...
			<div class="intro">
				<div class="title">${data.channel.status}</div>
